            ...
            <div class="x_panel" style="min-width: 740px;">
              ...
              <div class="x_content">
                <form>
                  <div class="pot">
                  <div class="row">
                    <div class="ex"><input type="checkbox" name=""><b>PZ-1</b></div>
                    <div class="ex"><input type="checkbox" name=""><b>PZ-9</b></div>
                ...
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>r_time</td>
                      <td>
                        <a href="/hzaulab/index.php/Admin/Field/">同意 <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/hzaulab/index.php/Admin/Field/" >拒绝 <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaulab/index.php/Admin/Field/equipment_app_show"><<?php echo ($vo["r_name"]); ?>></a></td>
                      <td><<?php echo ($vo["r_time"]); ?>></td>
                      <td>
                        <a href="/hzaulab/index.php/Admin/Field/notice_luanch" data-toggle="modal" data-target="#myModal" >同意 <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/hzaulab/index.php/Admin/Field/" >拒绝 <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                    <?php } else { ?>
                    <tr>
                      <td><a href="/hzaulab/index.php/Admin/Field/equipment_app_show"><<?php echo ($vo["r_name"]); ?>></a></td>
                      <td><<?php echo ($vo["r_time"]); ?>></td>
                      <td><a href="/hzaulab/index.php/Admin/Field/notice_luanch" data-toggle="modal" data-target="#myModal" >同意 <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/hzaulab/index.php/Admin/Field/" >拒绝 <i class="fa fa-close"></i></a>
                      </td>
                    </tr>
