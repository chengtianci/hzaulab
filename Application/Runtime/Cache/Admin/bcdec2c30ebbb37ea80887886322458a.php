    ...
    <div class="modal-content">
      ...
      <div class="right_col" role="main">
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>设施设备<small>Equipment</small></h2>
              ...
              <div class="x_content">
                ...
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>1</td>
                      <td><a href="/hzaulab/index.php/Admin/Equipment/equipmentdis">r_name</a></td>
                      <td>r_time</td>
                      <td></td>
                      <td></td>
                      <td>
                  ...
                  <!-- <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k % 2 == 0) { ?>
                    <tr>
                      <td><a href="/hzaulab/index.php/Admin/Equipment/equipmentdis"><<?php echo ($vo["r_name"]); ?>></a></td>
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>设备申请<small>Equipment Application</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li class="panel_toolbox_li"><a class="close-link"><i class="fa fa-close"></i></a>
                  </li>
                  <li class="panel_toolbox_li"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
              ...
              <div class="x_content">
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td></td>
                      <td><a href="/hzaulab/index.php/Admin/Equipment/equipment_app_show">r_name</a></td>
                      <td>r_time</td>
                      <td>
                        <a href="/hzaulab/index.php/Admin/Equipment/">同意 <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>设备申请历史<small>Equipment Application History</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li class="panel_toolbox_li"><a class="close-link"><i class="fa fa-close"></i></a>
                  </li>
                  <li class="panel_toolbox_li"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
