          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                <div class="conall">
                  <div class="pitbox">
                    <h4><a href="/hzaulab/index.php/Admin/Equipment/equipmentdis" >气相色谱质谱联用仪</a></h4>
                    <div class="pitexplan">
                      
                      <a href="/hzaulab/index.php/Admin/Equipment/equipmentdis" ><img src="/hzaulab/Public/face/images/eqt/1.jpg" alt=""></a>
                      <div class="explan">
                        <p>编  号: 1</p>
                        <p>地  点：东附楼111</p>
                        <p>价  值:15500</p>
                        <p>生产商:China</p>
                        <p>型  号：A1181asasassas</p>
                        <p>状  态：在用</p>
                      </div>
                    </div>
