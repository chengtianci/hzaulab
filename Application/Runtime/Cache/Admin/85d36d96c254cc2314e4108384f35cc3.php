            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <form class="form" action="" method="post">
                      <input type="text" class="gallery_title" name="gallery_title" id="gallery_title" placeholder="标题" value="<?php echo ($data["infoname"]); ?>">
                       
                      <input type="text" id="idInfor" value="<?php echo ($data["id"]); ?>" hidden>
                        <script id='container' style="height:350px;" name='content' type="text/plain">请填写通知的名称，编辑时，请删除本行</script>
                        <br><button type="button" id="saveContent" class="btn btn-primary">提交</button>
                        ...
                        <script type="text/javascript">
                            $(function () {
                                ...
                                $('#saveContent').click(function () {
                                    ...
                                    $.ajax({
                                        url: '/hzaulab/index.php/Admin/Regulation/doRegulation',//路径
                                        type: 'POST',
                                        dataType: 'json',
                                        data: param,
