                ...
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><a href="/hzaulab/index.php/Admin/Introduction/notice_show/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["infoname"]); ?></a></td>
                        <td><?php echo ($vo["infotime"]); ?></td>
                        <td>
                      
                          <a href="/hzaulab/index.php/Admin/Introduction/notice_edit/id/<?php echo ($vo["id"]); ?>" >编辑 <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <a href="/hzaulab/index.php/Admin/Introduction/deleteOne/id/<?php echo ($vo["id"]); ?>" >删除 <i class="fa fa-close"></i></a>
                        </td>
