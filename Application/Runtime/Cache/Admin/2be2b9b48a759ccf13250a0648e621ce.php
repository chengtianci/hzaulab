      ...
      <div class="right_col" role="main">
              ...
              <div class="x_content">
                ...
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td></td>
                      <td><a href="/hzaulab/index.php/Admin/Laboratory/labdis">r_name</a></td>
                      <td>r_time</td>
                      <td></td>
                      <td></td>
                      <td>
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
<<<<<<< HEAD
                <h2>公共实验室申请<small>Lab Application</small></h2>
=======
                <h2>申请<small>Lab Application</small></h2>
>>>>>>> 8111f25b271c20c48b9dbcf50d01aca4642f06f7
          ...
          <div class="col-md-10 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
<<<<<<< HEAD
                <h2>公共实验室申请历史<small>Lab Application History</small></h2>
=======
                <h2>申请历史<small>Lab Application History</small></h2>
>>>>>>> 8111f25b271c20c48b9dbcf50d01aca4642f06f7
                <ul class="nav navbar-right panel_toolbox">
                  <li class="panel_toolbox_li"><a class="close-link"><i class="fa fa-close"></i></a>
                  </li>
