...
<head>
  ...
  <link rel="stylesheet" href="/hzaulab/Public/face/css/room_show2_one.css" />
  ...
  <div id="main">
    <div class="container">
      ...
      <div class="planform_box">
        <ul class="small_nav">
          <li><a class="now_on" href="/hzaulab/index.php/Home/Room/room_show2">东附楼B102</a></li>
          <li><a   href="/hzaulab/index.php/Home/Room/room_show2_two">东附楼B103</a></li>
        </ul>
        <div class="planform">
          ...
          <div class="planbody">
            <form class="planbodyform">
              ...
              <div class="box1">
                <div class=" classbox1_1 hasin" id="1-3-1" name="B102"><input type="checkbox" name=""></div>
                <div class=" classbox1_2" id="1-3-2" name="B102"><input type="checkbox" name=""></div>
                <div class=" classbox1_3" id="1-3-3" name="B102"><input type="checkbox" name=""></div>
                <div class=" classbox1_4" id="1-2-1" name="B102"><input type="checkbox" name=""></div>
                <div class=" classbox1_5" id="1-2-2" name="B102"><input type="checkbox" name=""></div>
                <div class=" classbox1_6" id="1-2-3" name="B102"><input type="checkbox" name=""></div>
                <div class=" classbox1_7" id="1-1-1" name="B102"><input type="checkbox" name=""></div>
                <div class=" classbox1_8" id="1-1-2" name="B102"><input type="checkbox" name=""></div>
                <div class=" classbox1_9" id="1-1-3" name="B102"><input type="checkbox" name=""></div>
              </div>
              <div class="box2">
                <div class="div2_1">
                  <div class=" classbox2" id="1-1-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-2-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-3-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-4-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-1-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-2-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-3-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-4-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-1-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-2-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-3-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="1-4-3" name="B102"><input type="checkbox"  name=""></div>
                </div>
                <div class="div2_2">
                  <div class=" classbox2" id="2-1-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-2-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-3-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-4-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-1-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-2-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-3-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-4-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-1-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-2-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-3-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-4-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-1-4" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-2-4" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-3-4" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-4-4" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-1-5" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-2-5" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-3-5" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="2-4-5" name="B102"><input type="checkbox"  name=""></div>
                </div>
                <div class="div2_3">
                  <div class=" classbox2" id="3-1-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-2-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-3-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-4-1" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-1-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-2-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-3-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-4-2" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-1-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-2-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-3-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-4-3" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-1-4" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-2-4" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-3-4" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-4-4" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-1-5" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-2-5" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-3-5" name="B102"><input type="checkbox"  name=""></div>
                  <div class=" classbox2" id="3-4-5" name="B102"><input type="checkbox"  name=""></div>
                </div>
              </div>
              <div class="box3">
                <div class="div3_1">
