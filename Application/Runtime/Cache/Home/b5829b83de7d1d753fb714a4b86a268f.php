            ...
            <div class="planform">
              ...
              <div class="planbody">
                <form>
                  ...
                  <div class="inbox"  id="PZ-1" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-1" name="test">PZ-1</div>
                  <div class="inbox " id="PZ-2" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-2" name="test">PZ-2</div>
                  <div class="inbox" id="PZ-3" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-3" name="test">PZ-3</div>
                  <div class="inbox" id="PZ-4" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-4" name="test">PZ-4</div>
                  <div class="inbox" id="PZ-5" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-5" name="test">PZ-5</div>
                  <div class="inbox" id="PZ-6" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-6" name="test">PZ-6</div>
                  <div class="inbox" id="PZ-7" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-7" name="test">PZ-7</div>
                  <div class="inbox" id="PZ-8" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-8" name="test">PZ-8</div>
                  <div class="inbox" id="PZ-9" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-9" name="test">PZ-9</div>
                  <div class="inbox" id="PZ-10" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-10" name="test">PZ-10</div>
                  <div class="inbox" id="PZ-11" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-11" name="test">PZ-11</div>
                  <div class="inbox" id="PZ-12" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-12" name="test">PZ-12</div>
                  <div class="inbox" id="PZ-13" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-13" name="test">PZ-13</div>
                  <div class="inbox" id="PZ-14" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-14" name="test">PZ-14</div>
                  <div class="inbox" id="PZ-15" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-15" name="test">PZ-15</div>
                  <div class="inbox" id="PZ-16" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-16" name="test">PZ-16</div>
                  <div class="inbox" id="PZ-17" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-17" name="test">PZ-17</div>
                  <div class="inbox" id="PZ-18" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-18" name="test">PZ-18</div>
                  <div class="inbox" id="PZ-19" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-19" name="test">PZ-19</div>
                  <div class="inbox" id="PZ-20" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-20" name="test">PZ-20</div>
                  <div class="inbox" id="PZ-21" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-21" name="test">PZ-21</div>
                  <div class="inbox" id="PZ-22" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-22" name="test">PZ-22</div>
                  <div class="inbox" id="PZ-23" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-23" name="test">PZ-23</div>
                </div>


                <div class="box2">
                  <div class="inbox" id="PZ-24" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-24" name="test">PZ-24</div>
                  <div class="inbox" id="PZ-25" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-25" name="test">PZ-25</div>
                  <div class="inbox" id="PZ-26" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-26" name="test">PZ-26</div>
                  <div class="inbox" id="PZ-27" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-27" name="test">PZ-27</div>
                  <div class="inbox" id="PZ-28" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-28" name="test">PZ-28</div>
                  <div class="inbox" id="PZ-29" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-29" name="test">PZ-29</div>
                  <div class="inbox" id="PZ-30" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-30" name="test">PZ-30</div>
                </div>


                <div class="box3">
                  <div class="boxrow">
                       <div class="inbox2" id="PZ-31" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-31" name="test">PZ-31</div>
                       <div class="inbox2" id="PZ-32" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-32" name="test">PZ-32</div>
                  </div>
                  <div class="boxrow">
                       <div class="inbox2" id="PZ-33" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-33" name="test">PZ-33</div>
                       <div class="inbox2" id="PZ-34" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-34" name="test">PZ-34</div>
                  </div>
                </div>
                <div class="box4">
                  <div class="boxrow">
                       <div class="inbox2" id="PZ-35" name="openPot" title="状态：开放/锁定/占用/已预约(本人)；时间：8-15"><br><input type="checkbox" value="PZ-35" name="test">PZ-35</div>
                  </div>
                </div>
                </form>
