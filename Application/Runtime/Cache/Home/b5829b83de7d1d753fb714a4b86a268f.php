            ...
            <div class="planform">
              ...
              <div class="planbody">
                ...
                <div id="applyform">
                  ...
                  <form class="sqbg" id="sqbg">
                    <div class="down">
                      <div class="row">
                        <div class="le"><span class="hint">使用者姓名：</span><input disabled class="input" id="syz" type="text" name="syz" value="//自动">    </div>
                        <div class="ri"><span class="hint">联系方式：</span><input class="input" id="lxfs1" type="text" name="lxfs1" value="//必填"></div>
                      </div>
                      <div class="row">
                        <div class="le"><span class="hint">导师姓名： </span><input disabled class="input" id="dsxm" type="text" name="dsxm" value="//自动">   </div>
                        <div class="ri"><span class="hint">联系方式： </span><input disabled class="input" id="lxfs2" type="text" name="lxfs2" value="//自动"></div>
                      </div>
                      <div class="row">
                        <div class="le"><span class="hint">设施名称： </span><input disabled class="input" id="ssmc" type="text" name="ssmc" value="//自动">   </div>
                        <div class="ri"><span class="hint">设施位置：</span><input disabled class="input" id="sswz" type="text" name="sswz" value="//自动"></div>
                      </div>
                      <div class="row">
                        <div class="le"><span class="hint">设施编号：</span><input disabled class="input" id="ssbh" type="text" name="ssbh" value="//自动">   </div>
                        <div class="ri"><span class="hint">研究项目：</span><input  class="input" id="yjxm" type="text" name="yjxm" value="//必填"></div>
                      </div>
                      <div class="row">
                        <div class="le"><span class="hint">预约时间： </span><input class="input" id="kssj" type="date" name="kssj" value="//必填">   </div>
                        <div class="ri"><span class="hint">终止时间：</span><input class="input" id="zzsj" type="date" name="zzsj" value="//必填"></div>
                      </div>
                      <div class="row">
                        <div class="le"><span class="hint">样品物种：</span><input class="input" id="ypwz" type="text" name="ypwz" value="//必填">   </div>
                        <div class="ri"><span class="hint">备注: </span><input class="input" id="bz" type="text" name="bz" value="//选"></div>
                      </div><br>
                      <div class="row">
                        <a href=""><button type="button" onclick="fun1()">保存</button></a>
                        <a href=""><button type="button" >提交</button></a>
