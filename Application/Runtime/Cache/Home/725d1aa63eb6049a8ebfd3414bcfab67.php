...
<div id="RegisterBox">
  ...
  <div id="main">
    <div class="container">
      ...
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">平台概况</a> · <a href="#">通知公告</a> · <a href="#"><?php echo ($data["infoname"]); ?></a></nav>
        <header class="main_title"><h2><?php echo ($data["infoname"]); ?></h2></header>
