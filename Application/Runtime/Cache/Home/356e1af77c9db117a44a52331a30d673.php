    ...
    <div class="container">
      ...
      <div id="main_nav">
        <section>
          <h3>仪器设备</h3>
          <ul class="ultop">
            <li><a href="/hzaulab/index.php/Home/Equipment/equipment" style="border-left: 3px solid orange;">仪器设备简介</a></li>
            <li><a href="/hzaulab/index.php/Home/Equipment/equipment_show1" >仪器设备</a></li>
          </ul>
        </section>
      </div>
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">仪器设备</a></nav>
