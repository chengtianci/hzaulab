...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/hzaulab/Public/face/css/equipment_show2.css">
      ...
      <div id="main_nav">
        <section>
          ...
          <ul class="ultop">
            ...
            <li><a href="/hzaulab/index.php/Home/Equipment/equipment_show2" style="border-left: 3px solid orange;">试剂耗材</a></li>
          </ul>
        </section>
      </div>
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">仪器设备</a> · <a href="#">试剂耗材</a> </nav>
        <header class="main_title"><h2>试剂耗材</h2></header>
        <section class="article">
          <div>
            <form id="eqt_search" action="" method="post">
              ...
              <div class="radio_box">
                ...
                <input name="condition" value="2" type="radio"> 名称　
                <input name="condition" value="3" type="radio"> 编号　
              </div>
            </form>
          </div>
          <table class="table" cellspacing="0" cellpadding="0">
            ...
            <tr class="row">
              ...
              <td>zcb</td>
              <td>wu</td>
              <td><a href="/hzaulab/index.php/Home/Equipment/equipment_show2_apply"><button>领用</button></a></td>
            </tr>
             <tr class="row">
              <td>sj-001</td>
              <td>试剂</td>
