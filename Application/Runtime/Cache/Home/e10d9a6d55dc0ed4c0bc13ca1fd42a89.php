    ...
    <div class="container">
      ...
      <div id="main_nav">
        <section>
          <h3>平台概况</h3>
          <ul class="ultop">
            <li><a href="/hzaulab/index.php/Home/About/about_show1.html" style="border-left: 3px solid orange;">平台简介</a></li>
      ...
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">平台概况</a> · <a href="#">平台简介</a> </nav>
        <header class="main_title"><h2>平台简介</h2></header>
