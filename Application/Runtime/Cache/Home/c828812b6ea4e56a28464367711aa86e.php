...
<div id="RegisterBox">
  ...
  <div id="main">
    <div class="container">
      ...
      <div id="main_right">
        <nav class="top_nav"><a href="/hzaulab/index.php/home/Index/index.html">首页</a> · <a href="#">实验室</a> · <a href="#">公共实验室</a> </nav>
        <header class="main_title"><h2>公共实验室</h2></header>
        <section class="article">
          ...
          <div class="pitbox">
            <h4><a href="/hzaulab/index.php/Home/Laboratory/laboratory_show1_article" target="_blank">气相色谱质谱联用仪</a></h4>
            <div class="pitexplan">
              <a href="/hzaulab/index.php/Home/Laboratory/laboratory_show1_article" target="_blank"><img src="/hzaulab/Public/face/images/eqt/1.jpg" alt=""></a>
            </div>
          </div>
          <div class="pitbox">
            <h4><a href="/hzaulab/index.php/Home/Laboratory/laboratory_show1_article" target="_blank">气相色谱质谱联用仪</a></h4>
